        ...
        return new SwimHelpChapter("lsp", "Language Server Features",
                ...
                List.of(
                        ...
                        section("Finding symbols and highlights",
                                "Use Space-comma-H when you want every read or write of the current symbol highlighted in the current document. Use g s to list document symbols such as classes, functions, methods, and fields in the current file. Use g S when you remember a symbol name but not the file; SWIM prompts for a workspace-symbol query and then opens a result list.",
                                "<SPACE> , H\ngs\ngS"),
