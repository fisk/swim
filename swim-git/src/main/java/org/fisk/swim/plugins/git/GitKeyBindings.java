...
final class GitKeyBindings {
    ...
    private static final List<Binding> BINDINGS = List.of(
            ...
            new Binding(View.PULL_REQUESTS, "/", "Views", "edit name"),
            new Binding(View.PULL_REQUESTS, "L", "Views", "edit labels"),
            new Binding(View.PULL_REQUESTS, "A", "Views", "edit author"),
            new Binding(View.PULL_REQUESTS, "S", "Views", "save view"),
            new Binding(View.PULL_REQUESTS, "[", "Views", "previous view"),
            new Binding(View.PULL_REQUESTS, "]", "Views", "next view"),
            new Binding(View.PULL_REQUESTS, "0", "Views", "clear view"),
            new Binding(View.PULL_REQUESTS, "D", "Views", "delete view"),
            ...
            new Binding(View.PULL_REVIEW, "n", "Review", "next hunk"),
            new Binding(View.PULL_REVIEW, "p", "Review", "previous hunk"),
            new Binding(View.PULL_REVIEW, "<DOWN>", "Review", "scroll diff down"),
            new Binding(View.PULL_REVIEW, "<UP>", "Review", "scroll diff up"),
            new Binding(View.PULL_REVIEW, "m", "Review", "cycle mode"),
            new Binding(View.PULL_REVIEW, "1", "Review", "summary"),
            new Binding(View.PULL_REVIEW, "2", "Review", "unified"),
            new Binding(View.PULL_REVIEW, "3", "Review", "split"),
            new Binding(View.PULL_REVIEW, "4", "Review", "comments"),
            ...
            new Binding(View.PULL_REVIEW, "o", "Review", "open file"),
