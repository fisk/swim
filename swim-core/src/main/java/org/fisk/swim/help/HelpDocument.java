        ...
        return List.of(
                ...
                chapter("workspaces", "Todo, Shell, Sessions, and Plugin Panels",
                        ...
                        section("Plugin panels",
                                "Plugins can add full-screen workspaces, side panels, key bindings, and their own help chapters. When a plugin is installed, look for plugin-specific topics in :help, such as Git workflow, language-server support, mail, Slack, tree view, or debugger chapters.",
                                ":help\n:help git\n:help lsp"),
