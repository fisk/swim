        ...
        return List.of(
                ...
                chapter("diagnostics", "Diagnostics and Code Intelligence",
                        ...
                        section("Project diagnostic navigation",
                                ...
                                "g]\ng}")),
                chapter("lsp", "Language Server Features",
                        "A tutorial for the shared Java and C/C++ language-server commands.",
                        section("When LSP commands are available",
                                "Language-server features appear when a language plugin owns the current buffer. Java files use the Java LSP plugin. C and C++ files use clangd when the project has a compile_commands.json file in the project root or a build directory. Most commands run asynchronously: you can keep typing while the server answers, and stale answers are discarded if the buffer changed.",
                                ":help lsp\n:e src/Main.java\n:e src/main.cpp"),
                        section("Read what is at the cursor",
                                "Use Space-comma-h to open hover documentation for the symbol under the cursor. Space-comma-p opens signature help while editing a call. Diagnostics are still available with g x, and all LSP popups use j/k or arrow keys to move, Enter to jump or apply, and q or Esc to close.",
                                "<SPACE> , h\n<SPACE> , p\ngx\nj\n<ENTER>"),
                        section("Navigate through code",
                                "The fast paths g d and g r still go to definition and references. The full LSP navigation menu lives behind Space-comma: d goes to definition, D to declaration, y to type definition, i to implementation, and u to references. Space-comma-H lists document highlights. Space-comma-s lists symbols in the current file, while Space-comma-S prompts for workspace symbols.",
                                "gd\ngr\n<SPACE> , d\n<SPACE> , D\n<SPACE> , y\n<SPACE> , i\n<SPACE> , u\n<SPACE> , s\n<SPACE> , S"),
                        section("Ask the server to edit code",
                                "Space-comma-a opens code actions for the current line. Java organize imports is Space-comma-o. Space-comma-R prompts for a new symbol name and applies a rename edit. Space-comma-f formats the document, Space-comma-F formats the current line, and Space-comma-t asks for on-type formatting after a trigger character. Edits are applied through the normal undo path, so u should take you back.",
                                "<SPACE> , a\n<SPACE> , o\n<SPACE> , R\n<SPACE> , f\n<SPACE> , F\n<SPACE> , t\nu"),
                        section("Explore structure and extra server data",
                                "Space-comma-l shows code lens commands. Space-comma-n lists inlay hints, Space-comma-z creates folds from server folding ranges, and Space-comma-v lists selection ranges around the cursor. Space-comma-c opens call hierarchy, Space-comma-T opens type hierarchy, Space-comma-m lists document links, Space-comma-k shows linked editing ranges, and Space-comma-C offers color presentations when the cursor is on a color.",
                                "<SPACE> , l\n<SPACE> , n\n<SPACE> , z\n<SPACE> , v\n<SPACE> , c\n<SPACE> , T\n<SPACE> , m\n<SPACE> , k\n<SPACE> , C")),
