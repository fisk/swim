        ...
        return List.of(
                ...
                chapter("nemo", "Nemo Assistant",
                        ...
                        section("Nemo commands",
                                "Inside Nemo, :conversations, :workers, :new, :switch, :rename, :clear, :reset, :delete, and :abort manage Nemo conversations and delegated workers. :clear removes the visible chat history for the current conversation, while :reset can target another conversation by id. :permissions shows or changes tool permissions, :mcp lists MCP servers, :approvals lists approvals, and :swim-help reads this editor help.",
                                ":clear\n:conversations\n:workers"),
