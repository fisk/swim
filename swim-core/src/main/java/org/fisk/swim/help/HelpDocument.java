        ...
        return List.of(
                ...
                chapter("selection", "Selection, Registers, and Clipboard",
                        ...
                        section("Copying and pasting",
                                "yy copies the current line. y with a motion copies a range, such as y$ for the rest of the line. p pastes after the cursor and P pastes before the cursor. Line-wise copies paste as whole lines; character-wise copies paste inline.",
                                "yy\np\nyiw\nP"),
