        ...
        return List.of(
                ...
                chapter("selection", "Selection, Registers, and Clipboard",
                        ...
                        section("Moving selected text",
                                "The default leader key is Space. In NORMAL mode, Space-j and Space-k move the current line down or up, while Space-l and Space-h indent or outdent it. Put a count before the leader sequence to operate on several lines, such as 3 Space-j to move the current line and the next two lines down. The same leader-prefixed lowercase keys work in visual modes for the selected lines; a count there moves the whole selection several rows. Because the movement keys stay behind Space, classic Vim bindings like J for join and H/L for screen movement remain intact.",
                                "<SPACE>j\n3 <SPACE>j\nVjj2 <SPACE>k\n<SPACE>l"),
                ...
                chapter("commands", "Command Line Reference",
                        ...
                        section("Project search and location lists",
                                ":grep text searches project contents and opens matching results. :copen, :cnext, and :cprev walk the quickfix list. :lgrep searches only the current buffer into a location list, and :lopen, :lnext, and :lprev navigate it.",
                                ":grep parse error\n:cnext\n:lgrep TODO\n:lopen"),
                ...
                chapter("nemo", "Nemo Assistant",
                        ...
                        section("Nemo commands",
                                "Inside Nemo, :sessions, :workers, :new, :switch, :rename, :reset, :delete, and :abort manage conversations and delegated workers. :permissions shows or changes tool permissions, :mcp lists MCP servers, :approvals lists approvals, and :swim-help reads this editor help.",
                                ":swim-help files\n:permissions\n:workers"),
