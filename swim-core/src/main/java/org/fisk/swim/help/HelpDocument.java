        ...
        return List.of(
                ...
                chapter("workspaces", "Todo, Shell, Git, Debugger, and Integrations",
                        ...
                        section("Server sessions",
                                ":sessions lists the live swim instances managed by the background session server. Select one and press Enter to move the current terminal client to that instance. :session name switches directly to a named instance, creating it on demand with an empty launch argument list.",
                                ":sessions\n:session scratch")),
                chapter("nemo", "Nemo Assistant",
                        ...
                        section("Nemo commands",
                                "Inside Nemo, :sessions and :session manage live SWIM server sessions. :conversations, :workers, :new, :switch, :rename, :reset, :delete, and :abort manage Nemo conversations and delegated workers. :permissions shows or changes tool permissions, :mcp lists MCP servers, :approvals lists approvals, and :swim-help reads this editor help.",
                                ":sessions\n:conversations\n:workers"),
