...
public class HelpIndex {
    ...
    public static List<ListItem> createHelpList() {
        ...
        addSection(items, "Panels and commands",
                ...
                "t opens the fullscreen Todo workspace.",
                "Ctrl-t opens quick Todo capture from any screen.",
                ":tree opens the tree view on the left.",
        ...
        addSection(items, "Todo",
                "Press t or run :todo to open the Todo workspace.",
        ...
        addSection(items, "Nemo",
                ...
                "When approval is required, Nemo opens same-workspace approval options; use arrows and Enter to choose approve once, approve always, or deny.",
