...
final class NemoEditorControlSkill {
    private static final String CONTENT = String.join("\n",
            ...
            "For filename/path search, press g f in NORMAL mode to open Project Files; type the filename or path fragment there. Use g / or :grep only when searching file contents.",
