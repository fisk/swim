...
public class CodeActionPopupView extends View implements KeyBindingHintProvider {
    ...
    public CodeActionPopupView(Rect bounds) {
        ...
        _responders.addEventResponder("j", "Actions", "move down", () -> moveSelection(1));
        _responders.addEventResponder("k", "Actions", "move up", () -> moveSelection(-1));
        _responders.addEventResponder("<DOWN>", "Actions", "move down", () -> moveSelection(1));
        _responders.addEventResponder("<UP>", "Actions", "move up", () -> moveSelection(-1));
        _responders.addEventResponder("<ENTER>", "Actions", "apply selected", this::acceptSelection);
        _responders.addEventResponder("<ESC>", "Actions", "close", () -> {
    ...
    public List<KeyBindingHint> keyBindingHints() {
        return _actions.isEmpty() ? List.of() : _responders.keyBindingHints();
    }
