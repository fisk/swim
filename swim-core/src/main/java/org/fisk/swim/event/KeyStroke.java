...
public class KeyStroke {
    ...
    public KeyStroke(KeyType keyType) {
        this(keyType, false, false, false);
    }

    public KeyStroke(KeyType keyType, boolean ctrlDown, boolean altDown) {
        this(keyType, ctrlDown, altDown, false);
    }
    ...
    public KeyStroke(Character character, boolean ctrlDown, boolean altDown) {
        this(character, ctrlDown, altDown, false);
    }
    ...
    public boolean equals(Object other) {
        if (!(other instanceof KeyStroke stroke)) {
            return false;
        }
        return keyType == stroke.keyType && Objects.equals(character, stroke.character)
                && ctrlDown == stroke.ctrlDown && altDown == stroke.altDown && shiftDown == stroke.shiftDown;
    }

    @Override
    public int hashCode() {
        return Objects.hash(keyType, character, ctrlDown, altDown, shiftDown);
    }
}
