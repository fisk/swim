  ...
  protected void setupNavigationResponders() {
    ...
    _rootResponder.addEventResponder(
        new MotionResponder(
            ...
            count -> {
              allow("scroll buffer");
              repeat(
                  count * Math.max(1, bufferContext.getBufferView().getViewportHeight() / 2),
                  () -> bufferContext.getBufferView().scrollDown());
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
    ...
    _rootResponder.addEventResponder(
        new MotionResponder(
            ...
            count -> {
              allow("cursor motion");
              cursor.goWordForward(count, false);
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
            "W",
            ...
            count -> {
              allow("cursor motion");
              cursor.goWordForward(count, true);
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
            "b",
            ...
            count -> {
              allow("cursor motion");
              cursor.goWordBackward(count, false);
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
            "B",
            ...
            count -> {
              allow("cursor motion");
              cursor.goWordBackward(count, true);
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
            "e",
    ...
    _rootResponder.addEventResponder(
        new MotionResponder(
            ...
            count -> {
              allow("cursor motion");
              cursor.goParagraphForward(count);
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
            "{",
            ...
            count -> {
              allow("cursor motion");
              cursor.goParagraphBackward(count);
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
            ")",
            ...
            count -> {
              allow("cursor motion");
              cursor.goSentenceForward(count);
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
            "(",
            ...
            count -> {
              allow("cursor motion");
              cursor.goSentenceBackward(count);
            }));
    _rootResponder.addEventResponder(
        "%",
        "Navigation",
    ...
    _rootResponder.addEventResponder(
        ...
        allowed(
            ...
            () -> {
              cursor.setPosition(
                  buffer.getLineStartByIndex(bufferContext.getBufferView().getStartLine()));
            }));
    _rootResponder.addEventResponder(
        "M",
        "Navigation",
        ...
        allowed(
            ...
            () -> {
              cursor.setPosition(
                  buffer.getLineStartByIndex(
                      bufferContext.getBufferView().getStartLine()
    ...
    _rootResponder.addEventResponder(
        ...
        allowed(
            "scroll buffer",
            () -> {
              bufferContext.getBufferView().scrollPageUp();
            }));
    _rootResponder.addEventResponder(
        "<PAGEDOWN>",
        "Navigation",
        ...
        allowed(
            "scroll buffer",
            () -> {
              bufferContext.getBufferView().scrollPageDown();
            }));
    _rootResponder.addEventResponder(
        "g g",
        "Navigation",
        ...
        allowed(
            "cursor motion",
            () -> {
              window.performJump(cursor::goStartOfBuffer);
            }));
    _rootResponder.addEventResponder(
        new MotionResponder(
            "G",
